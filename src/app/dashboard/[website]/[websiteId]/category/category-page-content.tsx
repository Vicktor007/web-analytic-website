...
export const CategoryPageContent = ({hasEvents: initialEvents, category, websiteId}: CategoryPageContentProps) => {
    ...
    const [pagination, setPagination] = useState({
        ...
        const NumericFieldSumCards = () => {
          ...
          if(!pollingData.hasEvents){
            return <EmptyCategoryState websiteId={websiteId} categoryName={category.name}/>
        }
