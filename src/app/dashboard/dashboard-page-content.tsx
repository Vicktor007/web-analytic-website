                        ...
                        rounded-lg shadow-sm transition-all duration-300 group-hover:shadow-md ring-1 ring-black/5 "/>
                            <div className="relative p-6 z-10">
                                <div className="flex items-center gap-4 mb-6">
                                   ...
                                   />
                                    <div>
                                        ...
                                        {format(category.createdAt, "MMM d, yyyy")}</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    ...
                                    variant="ghost" size="sm" className="text-gray-500 hover:text-red-600 transition-colors" aria-label={`Delete ${category.name}`}>
