...
const getBadgeStyles = (color: BadgeColor) => {
        switch (color){
            ...
            case "#43b581":
                return "bg-green-50/10 text-green-400 ring-green-500/20"    
            default:
...
export const DiscordMessage = ({
        avatarAlt, avatarSrc, username, timestamp, badgeText, badgeColor= "#43b581", title, content
    }: DiscordMessageProps) => {
return(
    <div className="w-full flex items-start justify-start">
        ...
        <div className="w-full max-w-xl">
            <div className="flex items-center">
                <p className="font-semibold tex-white">{username}</p>
